...
export function EditMachineModal({
  ...
  }, [isOpen, initialName, initialImageBase64]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 py-6">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-sm max-h-[90vh] overflow-y-auto p-5 sm:p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-slate-800">Editar máquina</h3>
          <button
            type="button"
            onClick={handleClose}
            disabled={isLoading}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="edit-machine-name" className="block text-sm font-medium text-slate-700 mb-1">
              Nome da máquina
            </label>
            <input
          ...
          <div>
            <label htmlFor="edit-machine-image" className="block text-sm font-medium text-slate-700 mb-1">
              Imagem
            </label>
            <input
